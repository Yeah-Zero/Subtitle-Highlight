...
public class Configuration {
    ...
    public static Screen 屏幕(Screen 上级界面) {
        ...
        SubCategoryBuilder 基本颜色设置 = 构建器.entryBuilder().startSubCategory(Text.translatable("subtitle-highlight.configure.general.color")).setExpanded(true).setTooltip(Text.translatable("subtitle-highlight.configure.category.general.sub.color.tooltip"));
